...
return [
    ...
    | lớp trình xác thực. Một số quy tắc này có nhiều phiên bản như
    | các quy tắc kích thước. Hãy thoải mái điều chỉnh từng thông báo này ở đây.
    |
    */
    ...
    'ascii' => ':attribute chỉ có thể chứa các ký tự và ký hiệu chữ cái một byte.',
    ...
    | quy ước "attribute.rule" để đặt tên cho các dòng. Điều này giúp nhanh chóng
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau đây được sử dụng để thay thế trình giữ chỗ thuộc tính của chúng tôi
    | với một cái gì đó thân thiện hơn với người đọc như "Địa chỉ E-Mail" thay vì "email".
