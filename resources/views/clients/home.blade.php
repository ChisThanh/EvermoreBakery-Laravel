                        ...
                        <div
                            ...
                            <div class="mx-auto mb-2 w-full max-w-3xl text-center">
                                <h2 class="lineHeight text-3xl lg:text-[55px] mb-5 font-medium"
                                    ...
                                    Shop Now, Look Good Later</h2>
                                <p class="mt-5 text-neutral-500">We have a buch of collections for you! Lets explore
                                    and
                                    find
                                    your dream shoes, make it happen</p>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300">
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/airForce1"><img
                                            alt="Air Force 1 cover photo" loading="lazy" width="592" height="592"
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/airForce1.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                            ...
                            <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300">
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <div
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/blackLebron"><img
                                            alt="Lebron Black cover photo" loading="lazy" width="592" height="592"
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/blackLebron.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                            ...
                            <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300">
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/brownsb"><img
                                            alt="SB Low Brown cover photo" loading="lazy" width="592" height="592"
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/brownsb.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                            ...
                            <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300">
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/brsb"><img alt="BRSB cover photo"
                                            loading="lazy" width="592" height="592" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/brsb.jpg" style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                                        <h3 class="font-semibold">BRSB</h3>
                                ...
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/dunklow"><img
                                            ...
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/dunklow.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                                ...
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/lebronxx"><img
                                            ...
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/lebronxx.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                                ...
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <div
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/metcon5"><img
                                            ...
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/metcon5.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                                ...
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/metcon9"><img
                                            ...
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/metcon9.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                                ...
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <div
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/nike_blazer"><img
                                            ...
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/nike_blazer.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                            ...
                            <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300">
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/redlow"><img
                                            alt="Dunk Low Red cover photo" loading="lazy" width="592" height="592"
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/redlow.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                            ...
                            <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300">
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <button type="button"
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/slides"><img
                                            alt="Slides cover photo" loading="lazy" width="592" height="592"
                                            decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/slides.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                            ...
                            <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300">
                                <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                                    <div
                                        ...
                                        href="https://hotkicks.themealchemy.com/products/yellowLow"><img
                                            alt="Dunk Low Yellow cover photo" loading="lazy" width="592"
                                            height="592" decoding="async" data-nimg="1"
                                            class="h-full w-full object-cover object-bottom" src="/images/yellowLow.jpg"
                                            style="color: transparent;"></a>
                                </div>
                                <div class="mt-3">
                                    <div class="flex items-center justify-between">
                    ...
                    <div class="container">
                        <div
                            ...
                            <div class="mx-auto mb-2 w-full max-w-3xl text-center">
                                <h2 class="lineHeight text-3xl lg:text-[55px] mb-5 font-medium"
                                    style="line-height: 1.2em;">
                                    The Official Store of The Amazing Brand</h2>
                                <p class="mt-5 text-neutral-500">We work together with high quality and famous brands
                                    around
                                    the world</p>
                            </div>
                        </div>
                        <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                            <div class="rounded-2xl border border-neutral-300 p-3">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="h-20 w-20 overflow-hidden rounded-lg"><img alt="logo"
                                                loading="lazy" width="225" height="225" decoding="async"
                                                data-nimg="1" class="h-full w-full object-cover object-center"
                                                src="/images/new_balance.png" style="color: transparent;"></div>
                                        <div>
                                            ...
                                            <div class="flex items-center gap-1"><svg stroke="currentColor"
                                                ...
                                                <p class="text-sm">4.9 <span class="text-neutral-500">(10334
                                                        Reviews)</span>
                                                </p>
                                            </div>
                                ...
                                <div class="mt-3 grid grid-cols-2 gap-3">
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="440" height="440" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/new_balance1.jpg" style="color: transparent;"></div>
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="440" height="440" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/new_balance2.jpg" style="color: transparent;"></div>
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="440" height="440" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/new_balance3.jpg" style="color: transparent;"></div>
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="440" height="440" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/new_balance4.jpg" style="color: transparent;"></div>
                                </div>
                            </div>
                            <div class="rounded-2xl border border-neutral-300 p-3">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="h-20 w-20 overflow-hidden rounded-lg"><img alt="logo"
                                                ...
                                                data-nimg="1" class="h-full w-full object-cover object-center"
                                                src="/images/compass_profile.jpg" style="color: transparent;"></div>
                                        <div>
                            ...
                            <div class="rounded-2xl border border-neutral-300 p-3">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="h-20 w-20 overflow-hidden rounded-lg"><img alt="logo"
                                                loading="lazy" width="200" height="200" decoding="async"
                                                data-nimg="1" class="h-full w-full object-cover object-center"
                                                src="/images/nike_profile.jpg" style="color: transparent;"></div>
                                        <div>
                                ...
                                <div class="mt-3 grid grid-cols-2 gap-3">
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="592" height="592" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/yellowLow.jpg" style="color: transparent;"></div>
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="592" height="592" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/redlow.jpg" style="color: transparent;"></div>
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="592" height="592" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/dunklow.jpg" style="color: transparent;"></div>
                                    <div class="h-[150px] overflow-hidden rounded-lg bg-gray"><img alt="shoe"
                                            loading="lazy" width="592" height="592" decoding="async"
                                            data-nimg="1" class="h-full w-full object-cover object-bottom"
                                            src="/images/lebronxx.jpg" style="color: transparent;"></div>
                                </div>
                            </div>
                        </div>
