            ...
            @foreach ($products as $each)
                <div class="transitionEffect relative rounded-2xl p-3 shadow-md border-neutral-300 bg-secondary">
                    <div class="h-[250px] w-full overflow-hidden rounded-2xl lg:h-[220px] 2xl:h-[300px]">
                        <div class="absolute left-6 top-0 rounded-b-lg bg-primary px-3 py-2 text-sm uppercase text-white shadow-md">
                            Siêu hấp dẫn
                        </div>
                        <button type="button" onclick="likeProduct('{{ $each['slug'] }}', this)"
                            ...
                            <svg class="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="none">
                                @if ($each['liked'])
                        ...
                        <a class="h-[250px] w-full lg:h-[220px]" href="/products/{{ $each->slug }}">
                            <img alt="#" loading="lazy" width="592" height="592" decoding="async" data-nimg="1" class="h-full w-full object-cover object-bottom" src="/images/new_balance3.webp" style="color: transparent;">
                        </a>
                    </div>
                    <div class="mt-3">
    ...
    <div class="container flex flex-col items-center justify-center space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <a href="#" class="relative group overflow-hidden">
                <img src="/images/static/tiramisu.png" alt="Cinnamon Tiramisu" class="rounded-2xl w-full h-full object-cover">
                <div class="absolute bottom-0 left-0 rounded-b-2xl w-full bg-primary text-secondary text-xl font-semibold py-2 px-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    Tiramisu Cinamon
                </div>
            </a>
            <a href="#" class="relative group overflow-hidden">
                <img src="/images/static/cheesecake.png" alt="Berry Cheesecake" class="rounded-2xl w-full h-full object-cover">
                <div class="absolute bottom-0 left-0 rounded-b-2xl w-full bg-primary text-secondary text-xl font-semibold py-2 px-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    Cheesecake Berry
                </div>
            </a>
            <a href="#" class="relative group overflow-hidden">
                <img src="/images/static/mousse.png" alt="Raspberry Mousse" class="rounded-2xl w-full h-full object-cover">
                <div class="absolute bottom-0 left-0 rounded-b-2xl w-full bg-primary text-secondary text-xl font-semibold py-2 px-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    Mousse Raspberry
                </div>
            </a>
            ...
            @foreach ($categories as $category)
                <a href="#" class="rounded-2xl border-4 border-primary p-3 lg:w-1/3 w-1/2">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <div class="h-20 w-20 overflow-hidden rounded-lg">
                                <img alt="logo" loading="lazy" width="130" height="130" decoding="async" data-nimg="1" class="h-full w-full object-cover object-center"
                                src="/images/compass_profile.jpeg" style="color: transparent;"/>
                            </div>
                            <div>
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-3">
                        <div class="h-[150px] overflow-hidden rounded-lg bg-gray">
                            <img alt="shoe" loading="lazy" width="1299" height="1299" decoding="async"
                                data-nimg="1" class="h-full w-full object-cover object-bottom"
                                src="/images/compass1.jpg" style="color: transparent;">
                        </div>
                        <div class="h-[150px] overflow-hidden rounded-lg bg-gray">
                            <img alt="shoe" loading="lazy" width="738" height="738" decoding="async"
                                data-nimg="1" class="h-full w-full object-cover object-bottom"
                                src="/images/compass2.jpg" style="color: transparent;">
                        </div>
                        <div class="h-[150px] overflow-hidden rounded-lg bg-gray">
                            <img alt="shoe" loading="lazy" width="1477" height="1477" decoding="async" data-nimg="1" class="h-full w-full object-cover object-bottom"
                                src="/images/compass3.png" style="color: transparent;">
                        </div>
                        <div class="h-[150px] overflow-hidden rounded-lg bg-gray">
                            <img alt="shoe" loading="lazy" width="4480" height="4480" decoding="async" data-nimg="1" class="h-full w-full object-cover object-bottom" src="/images/compass4.jpg" style="color: transparent;">
                        </div>
                    </div>
                </a>
            @endforeach
