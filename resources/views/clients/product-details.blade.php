    ...
    <div class="container items-stretch justify-between space-y-10 lg:flex lg:space-y-0 row">
        ...
        <div class="basis-[45%] space-y-8">
            ...
            <div class="flex items-center gap-1">
                <button type="button" class="ttnc-ButtonCircle flex items-center justify-center rounded-full !leading-none focus:ring-transparent disabled:bg-opacity-70 overflow-hidden border border-neutral-400 w-11 h-11">
                    <img alt="nike_profile" loading="lazy" width="200" height="200" decoding="async" data-nimg="1" class="h-full w-full object-cover" src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fnike_profile.34f18203.jpg&amp;w=640&amp;q=75">
                </button>
            ...
            <div class="space-y-2">
                <div class="flex flex-row items-center justify-start text-sm font-medium text-center space-x-4">
                    <button id="tab-info" class="flex items-center justify-center p-4 border-b-2 border-primary rounded-t-lg group hover:border-primary">
                    ...
                    <button id="tab-nutrition"  class="flex items-center justify-center p-4 border-primary rounded-t-lg group hover:border-b-2">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-primary group-hover:fill-primary" aria-hidden="true">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <title>ionicons-v5-m</title>
                                <path d="M352,128c-32.26-2.89-64,16-96,16s-63.75-19-96-16c-64,6-96,64-96,160,0,80,64,192,111.2,192s51.94-24,80.8-24,33.59,24,80.8,24S448,368,448,288C448,192,419,134,352,128Z" style="fill:none;stroke:#451c0d;stroke-miterlimit:10;stroke-width:32px"></path>
                                <path d="M323.92,83.14c-21,21-45.66,27-58.82,28.79A8,8,0,0,1,256,103.2a97.6,97.6,0,0,1,28.61-59.33c22-22,46-26.9,58.72-27.85A8,8,0,0,1,352,24.94,98,98,0,0,1,323.92,83.14Z"></path>
                    ...
                    <button id="tab-ingredient" class="flex items-center justify-center p-4 border-primary rounded-t-lg group hover:border-b-2 ">
                        <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-primary group-hover:fill-primary">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier"> 
                ...
                <div class="p-2">
                    ...
                    <div id="content-nutrition" class="w-full hidden">
                        <div class="grid grid-flow-col gap-4">
                            <div class="col">Tên Dinh Dưỡng</div>
                    ...
                    <div id="content-ingredient" class="w-full hidden">
                        <div class="grid grid-flow-col gap-4">
                            <div class="col">Tên Nguyên Liệu</div>
                            <div class="col">Tên Nguyên Liệu</div>
                            <div class="col">Tên Nguyên Liệu</div>
                            <div class="col">Tên Nguyên Liệu</div>
                        </div>
            ...
            <div class="flex items-center gap-5">
                <button onclick="window.location.href='/products/buy-now/{{ $data->slug }}'" class="relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6  rounded-full bg-primary text-white hover:bg-primary/80 disabled:bg-opacity-70 w-full"> Mua Ngay </button>
                <button class="relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6  flex w-full items-center gap-1 border-2 border-primary text-primary" onclick="window.location.href='/products/add-to-cart/{{ $data->slug }}'">
    ...
    <div class="container flex flex-col items-center justify-center space-y-8">
        ...
        <form class="flex lg:flex-row flex-col items-center justify-center space-x-4 w-full">
            <div class="flex items-center">
                <svg class="w-4 h-4 text-tertiary ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                ...
                <svg class="w-4 h-4 ms-1 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                </svg>
            </div>
            <input type="text" name="" id="" class="w-1/2 border-2 border-primary rounded-xl focus:border-tertiary focus:outline-none focus:ring-1 focus:ring-tertiary" placeholder="Nhập bình luận của bạn">
            <button type="submit" class="rounded-xl p-3 bg-primary text-secondary hover:bg-tertiary">Bình Luận</button>
        </form>
    </div>
    <div class="container flex flex-col items-center justify-center space-y-8">
        <div class="text-center w-full lg:px-4">
        ...
        <div class="flex items-center justify-center">
            <button class="relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6  rounded-full bg-primary text-white hover:bg-primary/80 disabled:bg-opacity-70 ">Xem Thêm</button>
        </div>
    </div>
</div>
