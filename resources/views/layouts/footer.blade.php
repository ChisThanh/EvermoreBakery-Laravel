<div class="bg-secondary text-primary border-t border-neutral-200">
    <div
        class="container flex lg:flex-row flex-col items-start justify-between gap-10 py-10 lg:divide-y-0 divide-y-2 divide-primary">
        <div class="lg:w-1/2 w-full space-y-4">
            ...
            <p class="text-justify">
                Tại Evermore Bakery, chúng tôi tự hào mang đến những chiếc bánh thủ công được làm từ những nguyên liệu
                tốt nhất và niềm đam mê thuần khiết. Hãy ghé thăm để thưởng thức hương vị ngọt ngào, nơi mỗi chiếc bánh
                đều chứa đựng tình yêu và sự sáng tạo.
            </p>
        ...
        <div class="lg:w-1/4 w-full lg:pt-0 pt-6">
            ...
            <ul class="list-decimal text-base font-normal mx-4 lg:mx-0">
                ...
                <li class="lg:px-2"><a href="/products">Sản Phẩm</a></li>
                <li class="lg:px-2"><a href="/contact">Liên Hệ</a></li>
                <li class="lg:px-2">ĐC: TPHMC</li>
                <li class="lg:px-2">SĐT: 113</li>
            </ul>
        </div>
    </div>
</div>
