<div class="nc-Header sticky inset-x-0 top-0 z-50 w-full bg-[#fff9ed] text-[#451c0d] border-b border-neutral-200">
    <div class="container flex items-center justify-around py-4">
        ...
        <div class="relative hidden lg:block w-1/3">
            <div class="flex items-center">
                <div class="mx-3 flex shrink-0 items-center font-medium decoration-[#451c0d] decoration-2 underline-offset-8 hover:underline">
        ...
        <div class="flex items-center lg:w-1/3 justify-end">
            <button type="button" class="w-8 h-8 mx-3 flex items-center rounded-full p-2 bg-[#451c0d]" id="search-button">
            ...
            <button type="button" class="w-8 h-8 mx-3 relative flex items-center rounded-full p-2 bg-[#451c0d]" id="cart-button">
                ...
                <div class="absolute inline-flex items-center justify-center w-6 h-6 p-1 text-xs font-semibold text-white bg-[#dda54a] border border-white rounded-full -top-[18px] -end-[18px]">
                    {{ sizeof($cartDetails) }}
                </div>
            </button>
            @if(auth()->check())
                <button type="button" class="w-8 h-8 mx-3 flex items-center rounded-full border border-[#451c0d] overflow-hidden" id="user-button">
            ...
            @else
                <button type="button" class="w-8 h-8 mx-3 flex items-center rounded-full p-2 bg-[#451c0d]" id="login-button">
