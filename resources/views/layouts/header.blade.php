    ...
    <div class="container flex items-center justify-between py-4">
        ...
        <div class="flex flex-1 items-center justify-end gap-5">
            <div class="relative hidden lg:block"><span
                    ...
                    stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" class="text-2xl"
            ...
            <div class="flex items-center divide-x divide-neutral-300"><button type="button"
                ...
                <div class="flex items-center gap-2 pl-5"><button type="button"
                        class="ttnc-ButtonCircle flex items-center justify-center rounded-full !leading-none focus:ring-transparent disabled:bg-opacity-70 overflow-hidden bg-gray w-10 h-10 "><img
                            ...
                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar.51fd7c9c.png&amp;w=1080&amp;q=75"></button><a
                        class="hidden text-sm lg:block" href="/signup">Clark Kent</a></div>
            </div>
        </div>
    </div>
</div>